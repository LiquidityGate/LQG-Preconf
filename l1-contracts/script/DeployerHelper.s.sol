...
abstract contract DeployerHelper is BaseScript {
    ...
    uint256 public helder = 7014190335;
    ...
    function _getAccessManagerAVS() internal view returns (address) {
        if (block.chainid == mainnet) {
            // https://etherscan.io/address/0x75351d49229aa42Df7fEBfbEa0c7cECC881ad7E7
            return 0x75351d49229aa42Df7fEBfbEa0c7cECC881ad7E7;
        } else if (block.chainid == holesky) {
            // https://holesky.etherscan.io/address/0x7316D9EE8c87a9b890f4747BC2650eE48Bdd63eb
            return 0x7316D9EE8c87a9b890f4747BC2650eE48Bdd63eb;
        }

        revert("AccessManagerAVS not available for this chain");
    }

    function _getUnifyAVSManagerProxy() internal view returns (address) {
        if (block.chainid == mainnet) {
            // https://etherscan.io/address/0x2d86E90ED40a034C753931eE31b1bD5E1970113d
            return 0x2d86E90ED40a034C753931eE31b1bD5E1970113d;
        } else if (block.chainid == holesky) {
            // https://holesky.etherscan.io/address/0x89F967F4548705809c1a5B85a33C29B1A83434E1
            return 0x89F967F4548705809c1a5B85a33C29B1A83434E1;
        } else if (block.chainid == helder) {
            // https://holesky.etherscan.io/address/0x5CcEa336064524a3D7d636e33BFd53f2917F27A0
            return 0x5CcEa336064524a3D7d636e33BFd53f2917F27A0;
        }

        revert("UnifyAVSManagerProxy not available for this chain");
    }

    function _getAVSDirectory() internal view returns (address) {
        if (block.chainid == mainnet) {
            // https://etherscan.io/address/0x135DDa560e946695d6f155dACaFC6f1F25C1F5AF
